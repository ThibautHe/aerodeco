...
export default function Devis() {
  ...
  return (
    <div
      className="bg-devis-bg bg-fixed bg-no-repeat bg-center pt-20 pb-20"
      id="devis"
    >
      <div className="p-4">
        <div className="relative min-h-[740px] w-full sm:w-[600px] bg-main-light rounded-3xl drop-shadow-2xl m-auto flex items-center flex-col justify-center">
          ...
          <form
            ...
            className="grid grid-cols-2 p-4 sm:w-9/12 gap-8 pt-4 sm:p-4"
            id="form1"
          >
        ...
        <Label callback={register} title="telephone"></Label> */}
            ...
            <button className="bg-mainBg text-main-light w-1/2 h-10 rounded-xl col-span-2 m-auto z-10">
              {isSubmitting ? "Envoye en cours..." : "Envoyer"}
            </button>
          </form>
          <svg
            className="rounded-3xl fill-mainBg z-0"
            xmlns="http://www.w3.org/2000/svg"
            viewBox="0 0 1440 320"
          >
